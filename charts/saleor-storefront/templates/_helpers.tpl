...
{{- if contains $name .Values.release }}
{{- .Values.release | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- printf "%s-%s" .Values.release $name | trunc 63 | trimSuffix "-" }}
{{- end }}
{{- end }}
{{- end }}
...
app.kubernetes.io/instance: saleor-k8s-staging
{{- end }}
